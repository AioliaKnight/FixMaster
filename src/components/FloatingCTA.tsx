...
export default function FloatingCTA({ lineUrl }: FloatingCTAProps) {
  ...
  return (
    <div className="fixed bottom-5 right-5 md:bottom-6 md:right-6 z-[9998] pb-safe pr-safe">
      <a
        href={href}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="透過 LINE 聯絡我們"
        className="group inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 glass-control glass-elevated text-[#06C755] bg-white/70 hover:bg-white/80 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#18d36a] cta-shine"
