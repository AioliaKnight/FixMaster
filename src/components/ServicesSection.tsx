        ...
        <div className="max-w-6xl mx-auto">
                        ...
                        <ul className="grid gap-3.5 px-1">
                          {service.features.map((feature, featureIndex) => (
                            <li key={featureIndex} className="flex items-start text-neutral-700 text-[15px] font-medium leading-tight">
                              <CheckCircle className="mr-3 h-5 w-5 text-[#00C805] shrink-0 mt-px" />
            ...
            >
              {additionalServices.map((service, index) => (
                <motion.div
                  ...
                  viewport={motionViewport}
                >
                  <div className="glass-control w-16 h-16 flex items-center justify-center mx-auto mb-4 text-neutral-900 shadow-(--elev-2)">
          ...
          >
            <div className="p-8 md:p-12 space-y-10">
              ...
              <div
                ref={flowRef}
                className="flex overflow-x-auto no-scrollbar snap-x snap-mandatory gap-4 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6 relative -mx-4 px-4 md:mx-0 md:px-0 pb-8 md:pb-0"
                role="region"
                aria-roledescription="carousel"
                aria-label="維修流程"
              >
